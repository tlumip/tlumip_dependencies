...
foreach(_expectedTarget gRPC::address_sorting gRPC::gpr gRPC::grpc gRPC::grpc_cronet gRPC::grpc_unsecure gRPC::grpc++ gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpc++_unsecure gRPC::grpc_plugin_support gRPC::grpcpp_channelz gRPC::grpc_csharp_ext gRPC::upb gRPC::grpc_cpp_plugin gRPC::grpc_csharp_plugin gRPC::grpc_node_plugin gRPC::grpc_php_plugin gRPC::grpc_python_plugin gRPC::grpc_ruby_plugin)
...
set_target_properties(gRPC::grpc PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "wsock32;ws2_32;OpenSSL::SSL;OpenSSL::Crypto;ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;gRPC::upb;gRPC::gpr;gRPC::upb"
)
...
set_target_properties(gRPC::grpc_unsecure PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "wsock32;ws2_32;ZLIB::ZLIB;c-ares::cares;gRPC::address_sorting;gRPC::upb;gRPC::gpr;gRPC::upb"
)
...
set_target_properties(gRPC::grpc++ PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "wsock32;ws2_32;OpenSSL::SSL;OpenSSL::Crypto;protobuf::libprotobuf;gRPC::grpc;gRPC::gpr;gRPC::upb"
)
...
set_target_properties(gRPC::grpc++_error_details PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "wsock32;ws2_32;protobuf::libprotobuf;gRPC::grpc++"
)
...
set_target_properties(gRPC::grpc++_unsecure PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "wsock32;ws2_32;protobuf::libprotobuf;gRPC::gpr;gRPC::grpc_unsecure;gRPC::upb"
)
...
add_library(gRPC::grpc_csharp_ext SHARED IMPORTED)
