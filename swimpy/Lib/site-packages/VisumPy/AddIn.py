...
class AddIn(object):
    ...
    def ClearErrors(self):
        ...
        self.State = ApplicationState.OK
        self.ErrorObjects = list()
    ...
    def __Prepare(self):
        ...
        (dummy, folderName) = os.path.split(os.getcwd())
        localeFolderPath = os.getcwd() + os.sep + "locale"
...
class AddInParameter(object):
    ...
    def Check(self, isBody, defaultParameter = None):
        ...
        if not self.addIn.IsInDebugMode:
            if self.visumParameter != None and self.visumParameter.Data != "":
        ...
        if param == None or (len(param) == 0 and isBody == True):
            msg = ""
            if self.addIn.Language == Language.German:
                msg = u"%s %s" %("Es wurden keine Add In Parameter gefunden.",
                                 "Bitte definieren Sie die Parameter bevor Sie das Add In ausführen.")
...
class AddInException(Exception):
    ...
    def __Prepare(self):
        ...
        if (isinstance(exeptionType, str) or isinstance(exeptionType, unicode)) and exceptionArgs == None:
    ...
    def __getExceptionText(self, exceptionText, currentSearchLevel):
        ...
        stringText = ""
        textFromNextLevel = ""
        if exceptionText == None or currentSearchLevel >= self.TextSearchLevel:
            return unicodeText
