...
def __GetPythonPathList(VISUMPath):
    pathList = []
    pathList.append(VISUMPath + "\\PythonModules")
    pathList.append(VISUMPath + "\\PythonModules\\wxPython")
    pathList.append(VISUMPath + "\\PythonModules\\matplotlib")
    pathList.append(VISUMPath + "\\PythonModules\\osgeo")
    pathList.append(VISUMPath + "\\PythonModules\\pyproj")
    pathList.append(VISUMPath + "\\PythonModules\\VisumPy")
    return pathList
...
def ChangePythonSysPath(visum, bit):
    ...
    visum - The number of the Visum version (e.g. 150 or 160)
